...
源地址,现已删库[Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi)
...
```shell
$ git clone git@github.com:mozi1924/NeteaseCloudMusicApi.git
...
```shell
$ git clone https://github.com/mozi1924/NeteaseCloudMusicApi.git
$ cd NeteaseCloudMusicApi
$ npm install
```
...
![单元测试](https://raw.githubusercontent.com/Binaryify/NeteaseCloudMusicApi/master/public/static/screenshot1.png)
![单元测试](https://raw.githubusercontent.com/Binaryify/NeteaseCloudMusicApi/master/public/static/screenshot2.png)
